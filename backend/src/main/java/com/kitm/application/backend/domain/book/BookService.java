package com.kitm.application.backend.domain.book;

import com.kitm.application.api.book.IBookService;
import com.kitm.application.api.book.dto.BookDto;
import com.kitm.application.api.book.dto.UpsertBookDto;
import com.kitm.application.backend.domain.author.AuthorEntity;
import com.kitm.application.backend.domain.author.AuthorRepository;
import com.kitm.application.backend.domain.category.CategoryEntity;
import com.kitm.application.backend.domain.category.CategoryRepository;
import com.kitm.application.backend.domain.order.OrderEntity;
